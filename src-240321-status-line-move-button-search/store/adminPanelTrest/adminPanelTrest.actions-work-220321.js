...
export const fetchObjectsListAsync = (objectType='2', organization='0', limit='100' , offset='0', startDate='01-01-2021', endDate='21-03-2021', objName='',  orgName='', objType="ОО" , objKind='' , objStatus=10, sortCol='date' , sortType='desc') => {
  ...
  return (dispatch) => { 
    postData('https://ismggt.ru/query/objects/list', {objectType:objectType, organization:organization, limit:limit , offset:offset, startDate:startDate, endDate:endDate ,objName:objName , orgName: orgName , objType:objType, objKind:objKind , objStatus:objStatus , sortCol:sortCol , sortType:sortType })
