...
export default function SearchPanel({setSearchText, setField}) {
  ...
  const [searchType, setSearchType] = React.useState('objName');
  ...
  return (
    <div style={{ display:'flex', alignItems:'center'}}>
      ...
      <FormControl className={classes.margin}>
        ...
        >
          <MenuItem value='objName'>Наименование объекта</MenuItem>
          <MenuItem value='organization'>Балансодержатель</MenuItem>
          <MenuItem value='objType'>Тип</MenuItem>
        </Select>
      </FormControl>
