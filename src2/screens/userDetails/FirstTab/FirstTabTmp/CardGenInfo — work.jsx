  ...
  return (
    <List className={classes.root}>
      ...
      <ListItem>
        ...
        {/* <ListItemText primary="Смежники" secondary={currObj.objRelatives.join(', ')} /> */} 
        {objRect && objRect.map((rec, index) => {
          if (currObj.objRelatives.join(', ').includes(rec.receip.objectID.toString())){
            return <ListItemText key={index} primary={''} secondary={rec.receip.objname} />
            // return <ListItemText primary={rec.receip.objectID} secondary={rec.receip.objname} />
          }else {
            return <ListItemText  key={index} primary={''} secondary={rec.receip.objectID} />
          }
          // return 'dd'
        })}
      </ListItem>
